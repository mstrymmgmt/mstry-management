      ...
      <div className="mx-auto w-[min(1160px,calc(100%_-_40px))]">
        ...
        <div className="relative grid gap-4">
          ...
          {processSteps.map((step, index) => (
            <motion.article
              className="relative rounded-mstry border border-white/10 bg-[#111827]/58 p-6 transition hover:border-mstry-gold/35 md:ml-16"
              key={step.title}
            ...
            >
              ...
              <h3 className="mt-3 font-display text-2xl font-black text-white">{step.title}</h3>
        ...
        <div className="mt-8 rounded-mstry border border-mstry-gold/20 bg-mstry-gold/10 p-6">
