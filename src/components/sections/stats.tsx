...
export function Stats() {
  ...
  return (
    <section className="py-20">
      ...
      <div className="mx-auto grid w-[min(1160px,calc(100%_-_40px))] overflow-hidden rounded-mstry border border-mstry-gold/15 bg-[#111827]/70 md:grid-cols-5">
      ...
      <motion.div
        className="mx-auto mt-10 w-[min(1160px,calc(100%_-_40px))] border-t border-mstry-gold/20 pt-8"
        initial={{ opacity: 0, y: 18 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, margin: "-80px" }}
      ...
      >
        <div className="grid gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-start">
          <div>
            <span className="text-xs font-black uppercase tracking-[0.2em] text-mstry-gold">Head Office</span>
            <p className="mt-3 font-display text-2xl font-black text-white">{companyFootprint.headOffice.address}</p>
          </div>
          <div>
            <span className="text-xs font-black uppercase tracking-[0.2em] text-mstry-gold">Global Operating Footprint</span>
